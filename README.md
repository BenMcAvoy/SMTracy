...
Welcome to your new DLL mod, you should see you now have a `SMTracy.sln` file, all the files you see here were generated from the template.

## Usage

1. Clone this repository locally
2. Open the `SMTracy.sln` file in Visual Studio
...
6. You can then view the https://github.com/BenMcAvoy/SMTracy/releases to see your mod's release page, edit the draft and publish it when you are ready.
